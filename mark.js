...
document.forms['thisone'].chkLLG.checked=localStorage.chkLLG;
	...
	document.querySelector('#chkBarG').checked = localStorage.chkLineG;
	...
	console.log("mark:"+document.querySelector('#chkMLG').checked);
	
	/*$("#file1").change(function() {
        //alert('changed!');

        //$('#id').html( $(this).files[0] );
